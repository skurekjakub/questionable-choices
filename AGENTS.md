...
| `test/fixtures/hook-events.jsonl`                | The empirical record of what Claude Code hooks actually send. It is evidence, never edited to make a test pass. `statusline-payload.json` and `compaction-events.jsonl` likewise.                                                                                                                                                        |
